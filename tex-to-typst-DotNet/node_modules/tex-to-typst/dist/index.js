...
export function walkLatex(node) {
    ...
    if (Array.isArray(node.content)) {
        ...
        const parsed = content.reduce((list, next, i, array) => {
            ...
            if (next.type === 'macro' && next.content === 'middle' && ((_d = array[i + 1]) === null || _d === void 0 ? void 0 : _d.content) === '|') {
                skip += 1;
            }
            list.push(next);
            return list;
...
class State {
    ...
    addWhitespace() {
        ...
        if (!this._value || lastTwoChar === ')[')
            return; // e.g. `#text(fill: red)[V]
        this._value += ' ';
    }
    write(str) {
        if (!str)
